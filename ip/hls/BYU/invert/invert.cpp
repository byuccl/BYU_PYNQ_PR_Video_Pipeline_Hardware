...
void invert_hls(video_stream* stream_in_24, video_stream* stream_out_24, ctl_t ctl) {
...
#pragma HLS pipeline II=1
	...
	stream_out_24->data.R = 255-tmp.R;
	stream_out_24->data.G = 255-tmp.G;
	stream_out_24->data.B = 255-tmp.B;
